...
# Webapp
<p class="text-center">
<a href=[FootballPredictions](web_app:JidtqGs)  class="btn btn-datasets-color btn-cta-big-mod"><i class="icon-dku-sample_project" class="btn-cta-big-mod-icon" />Web Application</a>
</p>
