...
def get_predictions():
    ...
    df = df.rename(columns={"event_date": "Match Start", "homeTeam_team_name": "Home Team", "awayTeam_team_name": "Away Team", "league_name":"league", "venue":"Venue", "proba_Home":"Prob Home Win", "proba_Away":"Prob Away Win", "proba_Draw":"Prob Draw", "prediction":"Prediction"}, errors="raise")
    df = df.sort_values("Match Start", ascending=True).head(max_rows)
